...
<body>
    <div class="container-fluid">
        <h2 class="text-center mb-5 mt-5 primary">Admin Login</h2> 
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-lg-6 col-xl-5">
                <img src="image/traffic-police-cartoon-vector-36.png" alt="adminimage" class="img-fluid">
            </div>
            <div class="col-lg-6 col-xl-5">
                <form action="" method="post">
                    ...
                    <div>
                        ...
                        <p class="small fw-bold mt-2 pt-1">Don't have an account?
                            <a href="admin_registration.php" class="link-primary">Register</a>
                        </p>
                    </div>
                </form>
            </div>
